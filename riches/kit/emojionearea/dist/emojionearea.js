...
(function(factory, global) {
            ...
            var autocomplete = function() {
                ...
                editor.textcomplete([{
                    ...
                    search: function(term, callback) {
                        ...
                        $.post('', data, function(data) {}).done(function(data) {
                            var data = $.parseJSON(data);
                            callback(data);
                        });
                    },
                    template: function(mention) {
                        return '<img class="mentimg" src="' + mention["img"] + '"></img>' + mention["name"];
                    },
                    index: 1,
    ...
    var cdn = {
        ...
        defaultBase3: $(".dumb .gdefaults > .baseurl").text()+"riches/kit/emojione/",
        base: null,
        isLoading: false
    };
